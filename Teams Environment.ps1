...
$tabFreeze = "EV PSTN Gateways","EV Users","Voice Routes","Call Queue","LIS Location","Calling Policies","Auto Attendant"
Function Write-DataToExcel
    {
        ...
        {Add-ConditionalFormatting -Worksheet $ws.Workbook.Worksheets[10] -Address "H2:H2" -RuleType ContainsText -ConditionValue "FALSE" -backGroundColor red -ForegroundColor white}
